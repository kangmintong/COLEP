...
class _ResNet(nn.Module):
    def __init__(self, num_layer_stack, n_class):
...
def resnet20(n_class=10):
    return _ResNet(num_layer_stack=3, n_class=n_class)


def resnet32(n_class=10):
    return _ResNet(num_layer_stack=5, n_class=n_class)


def resnet56(n_class=10):
    return _ResNet(num_layer_stack=9, n_class=n_class)
